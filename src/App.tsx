      ...
      <div className="min-h-screen bg-black flex items-center justify-center p-6">
        <div className="text-center space-y-8 max-w-sm w-full">
          ...
          <div className="space-y-2">
            <h1 className="text-4xl font-black tracking-tighter text-white uppercase">Controle de Fretes</h1>
            <p className="text-zinc-500 font-medium">Gestão de Carregamentos Agro</p>
          </div>
